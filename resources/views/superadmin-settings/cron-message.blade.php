<x-alert type="info">
    <div class="flex flex-col justify-between">
        <div class="flex justify-between">
            <div>
                <h6>@lang('messages.cronSetupInstruction')</h6>
            </div>
        ...
        <div class="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg mb-4">
            <h5 class="font-semibold text-gray-900 dark:text-white mb-2">@lang('messages.cronImportanceTitle')</h5>
            <ul class="list-disc pl-5 space-y-2 text-gray-700 dark:text-gray-300">
                <li>@lang('messages.cronImportancePoint1')</li>
                <li>@lang('messages.cronImportancePoint2')</li>
                <li>@lang('messages.cronImportancePoint3')</li>
                <li>@lang('messages.cronImportancePoint4')</li>
            </ul>
        </div>

        <div class="mt-3 mb-2">
            <code>* * * * * (@lang('messages.cronEveryMinute'))</code>
        </div>
        ...
        <div class="flex gap-2 items-center">
            ...
            <button type="button" id="copy-cron-command" class="btn text-gray-900 dark:text-white font-bold"
                aria-label="@lang('messages.copyCronCommand')"
                title="@lang('messages.copyCronCommand')">
        ...
        <div class="mt-3"><strong>@lang('messages.cronNoteLabel'):</strong>
            <ins>{{$phpPath}}</ins>
            @lang('messages.cronNoteDescription')
        </div>
    </div>
</x-alert>
