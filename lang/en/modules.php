...
return array (
  ...
  array (
    ...
    'itemImageUploadHelp' => 'Supported formats: JPEG, PNG, JPG, GIF, SVG. Maximum size: 2MB. Recommended size: 200 × 200 pixels.',
  ...
  array (
    ...
    'paystack' => 'Paystack',
    'mollie' => 'Mollie',
    'kotBillAndPayment' => 'KOT, Bill , Print & Payment',
    'cancelled' => 'Cancelled',
  ...
  'order.Order Placed' => 'Order Placed',
  'order.Order Confirmed' => 'Order Confirmed',
  'order.Order Preparing' => 'Order Preparing',
  'order.Order is Ready for Pickup' => 'Order is Ready for Pickup',
  'order.Order is Out for Delivery' => 'Order is Out for Delivery',
  'order.Food is Ready' => 'Food is Ready',
  'order.Order Served' => 'Order Served',
  'order.Picked Up by Delivery Person' => 'Picked Up by Delivery Person',
  'order.Reached Destination' => 'Order Reached Destination',
  'customer' => 
  array (
    'addCustomer' => 'Add Customer',
    'name' => 'Customer Name',
  ...
  array (
    ...
    'autoConfirmOrdersEnabledDescription' => 'Enable automatic order confirmation. Select when orders should be confirmed.',
    'autoConfirmOrdersBeforePayment' => 'Auto Confirm Order Status Before Payment',
    'autoConfirmOrdersAfterPayment' => 'Auto Confirm Order Status After Payment',
    'autoConfirmOrdersBeforePaymentDescription' => 'Enable this to automatically confirm order progress status before payment.',
    'autoConfirmOrdersAfterPaymentDescription' => 'Enable this to automatically confirm order progress status after payment.',
    ...
    'freshpay' => 'FreshPay',
    'enableFreshpay' => 'Enable FreshPay',
    'freshpayApiUrl' => 'FreshPay API URL',
    'freshpayMerchantId' => 'FreshPay Merchant ID',
    'freshpayMerchantSecret' => 'FreshPay Merchant Secret',
    'freshpayFirstname' => 'FreshPay First Name',
    'freshpayLastname' => 'FreshPay Last Name',
    'freshpayEmail' => 'FreshPay Email',
    'freshpayMethod' => 'FreshPay Method',
    'freshpayCallbackSecretKey' => 'FreshPay Callback AES Key',
    'freshpayCallbackHmacKey' => 'FreshPay Callback HMAC Key',
  ...
  'staff.Branch Head' => 'Branch Head',
  'staff.Super Admin' => 'Super Admin',
  'reservation' => 
  array (
    'slotType' => 'Slot Type',
  ...
  array (
    ...
    'selectFreshpayMethod' => 'Select a mobile money method',
    'payWithFreshpay' => 'Pay with FreshPay',
    'freshpayPendingTitle' => 'Payment request sent',
    'freshpayPendingDescription' => 'Confirm the mobile money debit on your phone. This window updates automatically.',
    'freshpayCustomerHelp' => 'Only the mobile number and method are required. The subscription amount is taken from the selected plan.',
    'reference' => 'Reference',
  ),
  'language' => 
  array (
