        ...
        <div class="px-4 py-3 border-gray-200 bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
            ...
            @else
                ...
                <div>
                    ...
                    <!-- Status Steps -->
                    <div class="flex flex-col justify-between text-gray-500 sm:flex-row sm:items-center sm:-mt-5 dark:text-gray-400">
                                ...
                                <div @class([
                                    ...
                                    @else
                                        ...
                                        @switch($status)
                                            ...
                                            @case('food_ready')
                                                    <svg class="w-4 h-4" fill="none" stroke="currentColor"
                                                        ...
                                                        <path stroke-linecap="round" stroke-linejoin="round"
                                                            stroke-width="2"
                                                            d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8c-1.11 0-2.08.402-2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M12 16c1.11 0 2.08-.402 2.599-1M19 7h2a2 2 0 012 2v6a2 2 0 01-2 2h-2.5M3 7h2a2 2 0 012 2v6a2 2 0 01-2 2H3.5" />
                                                    </svg>
                                            @break
                                            ...
                                            @break
                                            @case('picked_up')
                                                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" width="24" height="24" xmlns="http://www.w3.org/2000/svg"><path d="M3 13h2v6h14v-6h2v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2zm16-8h-2V3a2 2 0 0 0-2-2H9a2 2 0 0 0-2 2v2H5a2 2 0 0 0-2 2v4h18V7a2 2 0 0 0-2-2M9 5h6v2H9z"/></svg>
                                            @break
                                            @default
                                                <svg {!! $svgBase !!}>
            ...
            <div class="flex flex-col gap-1.5">
                ...
                <div class="flex flex-wrap gap-3 text-xs text-gray-600 dark:text-gray-400">
                    <div class="flex items-center gap-1.5">
                        ...
                        {{ Str::of($order->order_type)->replace('_', ' ')->title() }}
                    </div>
                    <div class="flex items-center gap-1.5">
                        <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="bg-white border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 dark:bg-gray-800">
            ...
            <div class="border-b border-gray-200 divide-y divide-gray-200 dark:border-gray-700 dark:divide-gray-700">
                @foreach ($order->items as $item)
                    @php
                        // Set price context for all modifiers before calculating (calculate once for reuse)
                        ...
                        // Calculate original amount for free items
                        $isFreeItem = $item->is_free_item_from_stamp ?? false;
                        $originalAmount = $isFreeItem ? (($item->price ?? 0) + $modifierTotal) * $item->quantity : 0;
                    @endphp
                                        ...
                                        <div class="flex flex-wrap items-center gap-1.5 text-xs text-gray-600 dark:text-gray-400">
                                            @if($taxMode === 'item' && $restaurant?->tax_inclusive && $item->tax_amount > 0)
                                                <span class="font-medium">
                                                    {{ currency_format(($item->price + $modifierTotal) - ($item->tax_amount / $item->quantity), $restaurant->currency_id) }}
                                                </span>
                                                <span class="text-gray-400 dark:text-gray-500">+ tax</span>
                                                <span class="text-gray-400 dark:text-gray-500">=</span>
                                            @endif
                                            <span class="font-medium">
                                                {{ currency_format($item->price + $modifierTotal, $restaurant->currency_id) }}
                                            </span>
                                            <span class="text-gray-400 dark:text-gray-500">×</span>
                    ...
                    @else
                        ...
                        <div class="mt-2">
                            ...
                            <div class="flex justify-between text-sm text-gray-500 dark:text-gray-400">
                                ...
                                <div>
                                    <span class="text-gray-900 dark:text-white">{{ currency_format($totalTax, $restaurant->currency_id) }}</span>
                                </div>
                            </div>
                        </div>
                        @endif
                ...
                @else
                    <div class="grid items-center w-full grid-cols-1 gap-4 mt-4 md:grid-cols-2">
                        ...
                        @endif
                            ...
                            <x-secondary-button wire:click='initiateMolliePayment({{ $paymentOrder->id }})'>
                                <span class="inline-flex items-center">
                        ...
                        @if ($paymentGateway->tap_status)
                            <x-secondary-button wire:click='initiateTapPayment({{ $paymentOrder->id }})'>
                                <span class="inline-flex items-center">
