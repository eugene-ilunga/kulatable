<x-dialog-modal maxWidth="md" wire:model.live="showUpgradeModal">
    <x-slot name="title">
        <h2 class="text-lg font-medium">@lang('modules.settings.upgradeLicense')</h2>
    </x-slot>
        ...
        <div class="px-4 py-6 mx-auto">
            ...
            <div class="text-center">
                ...
                <h2 class="text-2xl font-bold text-gray-800 dark:text-white mb-3">
                    @lang('messages.upgradeRequired')
                </h2>
                <p class="text-gray-600 dark:text-gray-400 mb-8">
                    @lang('messages.welcomeToUpgrade')
                </p>
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex flex-col sm:flex-row items-center justify-center gap-3">
                        ...
                        <x-primary-link href="{{ route('pricing.plan') }}" wire:navigate class="inline-flex items-center">
