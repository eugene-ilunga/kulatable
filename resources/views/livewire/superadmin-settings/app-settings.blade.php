<div
    ...
    <form wire:submit.prevent="submitForm">
        <div class="grid gap-6">
            <div class="grid lg:grid-cols-3 gap-6">
                ...
                <div>
                    ...
                    <div x-data="{ open: false, search: '' }" class="relative">
                        ...
                        <div x-show="open" wire:cloak @click.away="open = false" class="absolute z-50 w-full mt-1 bg-white dark:bg-gray-900 border border-gray-300 dark:border-gray-700 rounded-md shadow-lg max-h-60 overflow-y-auto">
                ...
                <div >
                    ...
                    <div class="flex gap-2 mt-2">
                        ...
                        <div x-data="{ isOpen: @entangle('phoneCodeIsOpen').live }" @click.away="isOpen = false" class="relative w-32">
                            ...
                            <ul x-show="isOpen" x-transition wire:cloak
            ...
            <div>
                <x-label for="showSupportTicket">
                    <div class="flex items-start space-x-4 p-4 rounded-lg border border-gray-200 hover:bg-gray-50 transition-colors duration-200 dark:border-gray-700 dark:hover:bg-gray-700/50">
                        <div class="flex-shrink-0">
                            <x-checkbox class="mt-1 h-5 w-5 rounded border-gray-300 text-primary-600 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700" name="showSupportTicket" id="showSupportTicket" wire:model='showSupportTicket' />
                        </div>

                        <div class="flex-1">
                            <h3 class="text-sm font-semibold text-gray-900 dark:text-white">
                                @lang('modules.settings.showSupportTicket')
                            </h3>
                            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                                @lang('modules.settings.showSupportTicketInfo')
                            </p>
                        </div>
                    </div>
                </x-label>
