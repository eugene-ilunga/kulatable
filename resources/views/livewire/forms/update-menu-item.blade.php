                    ...
                    <div class="space-y-4">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <div class="relative rounded-md mt-1">
                                    <x-input id="preparationTime" type="number" step="1" min="0" wire:model.defer="preparationTime" class="block w-full rounded text-gray-900 placeholder:text-gray-400" placeholder="0" />
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <x-select id="inStock" class="mt-1 block w-full" wire:model.defer="inStock">
                                    <option value="1">@lang('app.yes')</option>
                                    <option value="0">@lang('app.no')</option>
                                </x-select>
                    ...
                    <div class="space-y-6 mt-4" wire:key="simple-pricing-section">
                        ...
                        <div>
                            ...
                            <div class="relative mt-1">
                                ...
                                <x-input id="itemPrice" type="number" step="0.001" min="0" wire:model.defer="itemPrice" class="block w-full pl-10 pr-4" placeholder="0.00" />
                            </div>
                                ...
                                <div class="flex items-center justify-between p-3 bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-600" wire:key="order-type-{{ $orderType->id }}">
                                    ...
                                    <div class="flex items-center space-x-3">
                                        <div class="relative">
                                            ...
                                            <x-input type="number" step="0.001" min="0"
                                                wire:model.defer="orderTypePrices.{{ $orderType->id }}"
