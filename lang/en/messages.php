...
return array (
  ...
  'freshpayGatewayDisabled' => 'FreshPay is disabled for subscription payments.',
  'freshpayMissingConfiguration' => 'FreshPay configuration is incomplete.',
  'invalidFreshpayMethod' => 'Invalid FreshPay method.',
  'freshpayPaymentRequestSent' => 'Mobile money request sent. Confirm the payment on your phone.',
  'freshpayPaymentRequestFailed' => 'Unable to initiate the FreshPay payment request.',
  'freshpayPaymentFailed' => 'FreshPay payment failed.',
  ...
  'cronSetupInstruction' => 'Please set the following cron command on your server (Ignore if already done)',
  'watchTutorial' => 'Watch Tutorial',
  'cronImportanceTitle' => 'Why Cron Job Is Important:',
  'cronImportancePoint1' => 'Enables automated email notifications for orders, reservations, and password resets',
  'cronImportancePoint2' => 'Processes scheduled tasks like recurring payments and subscription renewals',
  'cronImportancePoint3' => 'Handles background tasks without affecting application performance',
  'cronImportancePoint4' => 'Prevents missed notifications and keeps your restaurant management system running smoothly',
  'cronEveryMinute' => 'Every Minute',
  'copyCronCommand' => 'Copy cron command',
  'cronNoteLabel' => 'Note',
  'cronNoteDescription' => 'in the above command is the path of PHP on your server. To ensure it works correctly, please enter the correct PHP path for your server and provide the path to your script. If you\'re unsure how to set up a cron job, you may want to consult with your server administrator or hosting provider.',
  'copied' => 'Copied',
  ...
  'phoneAlreadyExists' => 'This phone number is already registered. Please search and select the existing customer.',
