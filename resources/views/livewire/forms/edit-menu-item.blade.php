        ...
        <div class="space-y-4">
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <x-select id="menu" class="block mt-1 w-full" wire:model.defer="menu">
                        <option value="">--</option>
            ...
            <div>
                ...
                <div class="relative mt-1 rounded-md">
                    <x-input id="preparationTime" type="number" step="1" wire:model.defer="preparationTime"
            ...
            <div>
                ...
                <x-select id="isAvailable" class="block mt-1 w-full" wire:model.defer="isAvailable">
            ...
            <div>
                ...
                <x-select id="inStock" class="block mt-1 w-full" wire:model.defer="inStock">
                    <option value="1">@lang('app.yes')</option>
                    <option value="0">@lang('app.no')</option>
                </x-select>
            ...
            <div>
                ...
                <x-select id="kitchenType" class="block mt-1 w-full" wire:model.defer="kitchenType">
            ...
            <div>
                ...
                <x-select id="showOnCustomerSite" class="block mt-1 w-full" wire:model.defer="showOnCustomerSite">
                    <option value="1">@lang('app.yes')</option>
                    <option value="0">@lang('app.no')</option>
                </x-select>
            ...
            <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-3 mb-2" wire:key="tax-details-section">
                ...
                <div class="flex flex-col gap-1 text-xs">
                    ...
                    @if(!empty($taxInclusivePrice['tax_breakdown']))
                        <div class="ml-2 my-1">
                            @foreach($taxInclusivePrice['tax_breakdown'] as $tax)
                            <div class="flex justify-between text-gray-500 dark:text-gray-400" wire:key="tax-breakdown-{{ $tax['name'] }}">
                                <span>{{ $tax['name'] }} ({{ $tax['rate'] }}%)</span>
