                ...
                @if (!is_null(customer()))
                    ...
                    <div id="dropdownNavbar"
                        ...
                        <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownLargeButton">
                            ...
                            @if ($showLoyaltyMenu)
                                <li>
                                    <a href="{{ route('loyalty.customer.account', [$restaurant->hash]) . '?branch=' . $shopBranch->id }}" wire:navigate
                                        class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">@lang('loyalty::app.myLoyaltyAccount')</a>
                                </li>
                            @endif
                            @if (in_array('Table Reservation', $modules))
                                <li>
